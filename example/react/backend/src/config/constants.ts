...
export const EXAMPLE_API_PORT = Number(process.env.EXAMPLE_API_PORT ?? 4000);
...
export const EXAMPLE_ALLOWED_ORIGINS = (
  (process.env.EXAMPLE_ALLOWED_ORIGINS as string) ?? "http://localhost:3000"
).split(",");
